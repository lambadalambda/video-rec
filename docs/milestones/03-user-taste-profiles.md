# Milestone 03 — User taste profiles

Goal: maintain long-term + session taste vectors from interaction signals.
...
- [x] blend long-term + session with evidence-weighted `gamma`
